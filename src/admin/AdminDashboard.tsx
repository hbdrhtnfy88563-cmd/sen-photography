...
import {
  ...
  MessageSquare,
  Image as ImageIcon,
  Settings,import React, { useState, useEffect, useRef } from 'react';
import {
  ArrowLeft,
  Trash2,
  Edit2,
...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  // ------------------------------------------
  // WEDDING STORIES HANDLERS (MINIMAL)
  // ------------------------------------------
  ...
  return (
    <div className="min-h-screen bg-[#070708] text-[#e8e4dc] flex flex-col font-sans">
      ...
      {/* MODAL 2: PRE-WEDDING (ONLY TITLE & IMAGE) */}
      {preweddingModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      {/* MODAL 3: WEDDING STORY (ONLY TITLE & IMAGE) */}
      {storyModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#111114] border border-white/15 max-w-lg w-full p-6 sm:p-8 space-y-4 shadow-2xl">
            <h3 className="font-serif text-2xl text-white font-light">
      ...
      {/* MODAL 4: CINEMATIC FILM (ONLY TITLE, VIDEO LINK & POSTER) */}
      {filmModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#111114] border border-white/15 max-w-lg w-full p-6 space-y-4 shadow-2xl">
            <h3 className="font-serif text-2xl text-white font-light">
